  ...
  return <section id="contact" style={{ background: "var(--ivory)", padding: "88px 0" }}>
    <div className="wrap">
      <div style={{ maxWidth: 640, marginBottom: 40 }}>
        ...
        <p style={{ color: "var(--muted)", fontSize: 15.5, marginTop: 12, lineHeight: 1.6, maxWidth: 520 }}>Speak with the Girard team about managing your property, listing with us, or investing in our developments.</p>
      </div>
...
function Landing({ onStart, onSignIn }) {
  ...
  return (
    <div>
      ...
      {/* THE CASE — why Girard exists, stated plainly. Placed before the
          developments band so a first-time visitor understands the problem
        ...
        <div className="wrap">
          ...
          <div>
            ...
            <h2 className="serif" style={{ fontSize: "clamp(30px,4.6vw,58px)", fontWeight: 600, lineHeight: 1.06, letterSpacing: -.8, color: "var(--ink)", maxWidth: "18ch" }}>
              A market full of listings that were never <span style={{ fontStyle: "italic", color: "var(--gold-2)" }}>real</span>.
            </h2>
            <p style={{ color: "var(--muted)", fontSize: 16.5, lineHeight: 1.8, marginTop: 26, maxWidth: 620 }}>
              Girard verifies title, ownership and condition before anything is published. Landlords are paid
      ...
      <div className="wrap" style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", paddingTop: 40, paddingBottom: 60, maxWidth: 1000 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 16 }}>
          ...
          <button className="role-card rise" onClick={() => setPartner(true)}>
            ...
            <div style={{ color: "rgba(255,255,255,.68)", fontSize: 13.5, lineHeight: 1.5 }}>Maintenance vendors and support-service providers, apply to join our partner network.</div>
          </button>
        </div>
      </div>
          ...
          {isSignup && !termsOk ? <>
            <div style={{ background: "var(--navy-2)", border: "1px solid var(--navy-line)", borderRadius: 12, padding: "16px 18px", maxHeight: 300, overflow: "auto", marginBottom: 16 }}>
              ...
              {[["Girard's role", "Girard Property Limited provides a technology platform for property management, lettings, cross-border swaps and related services. Girard is not a party to any tenancy, sale or swap agreed between users, and does not guarantee any party, property, title or transaction."],
                ...
                <div style={{ fontSize: 12.5, color: "rgba(255,255,255,.7)", lineHeight: 1.6 }}>{d}</div>
              </div>)}
...
function HouseArt({ hue = 200, status, h = 140, photo }) {
  ...
  return <div style={{ position: "relative", height: h, borderRadius: 10, overflow: "hidden", background: "linear-gradient(140deg, hsl(" + hue + ",42%,22%), hsl(" + (hue - 10) + ",50%,34%))" }}>
    ...
    {!(photo && ok) && <div style={{ position: "absolute", right: 10, bottom: 10, background: "rgba(255,255,255,.9)", color: "var(--ink)", fontSize: 11.5, fontWeight: 700, padding: "3px 9px", borderRadius: 999, display: "flex", alignItems: "center", gap: 5 }}><ImageIcon size={12} /> Photos to follow</div>}
    ...
    {live.loading ? <PmCard style={{ marginBottom: 16 }}><div style={{ display: "flex", gap: 8, alignItems: "center", color: "var(--muted)", fontSize: 13.5 }}><Loader2 size={14} className="spin" /> Loading the latest published data\u2026</div></PmCard>
      ...
      : <>
        <PmCard style={{ marginBottom: 16, borderLeft: "3px solid var(--gold)" }}>
          <div style={{ color: "var(--ink)", fontSize: 14, lineHeight: 1.65 }}>{row.briefing}</div>
    ...
    <div className="wrap">
      <div className="cap-split" style={{ display: "grid", gridTemplateColumns: "1.1fr .9fr", gap: 40, alignItems: "center" }}>
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,.75)", fontSize: 15.5, marginTop: 14, lineHeight: 1.65, maxWidth: 520 }}>We work with maintenance vendors and support-service providers across legal, insurance, valuation, logistics and more, who receive job referrals across the Girard portfolio.</p>
  ...
  function body() {
    ...
    if (j.stage === 6 && isTemp) return <div style={{ display: "grid", gap: 16 }}>
      <PmCard>
        ...
        <div style={{ fontSize: 13.5, color: "var(--muted)", lineHeight: 1.55, marginBottom: 12 }}>Your temporary swap{j.tempFrom ? " runs " + j.tempFrom + (j.tempTo ? " to " + j.tempTo : "") : ""}. No documents or ownership change hands. Exchange access details with the counterparty, then mark the swap complete.</div>
    ...
    if (j.stage === 6) return <div style={{ display: "grid", gap: 16 }}>
      ...
      {!locked && <PmCard>
        ...
        {!j.contractText ? <PmBtn kind="navy" icon={Sparkles} onClick={genContract}>{gen ? "Drafting…" : "Draft contract of sale (AI)"}</PmBtn>
          : <div style={{ background: "var(--ivory-2)", border: "1px solid var(--cream-line)", borderRadius: 10, padding: 18, whiteSpace: "pre-wrap", fontSize: 13.5, lineHeight: 1.6, color: "var(--ink)", maxHeight: 420, overflow: "auto" }}>{j.contractText}</div>}
